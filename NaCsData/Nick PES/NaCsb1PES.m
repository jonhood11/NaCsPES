...
%function but with Tdis --> xi and De --> Ve.  Will be added to the b0 PES,
...
A01 = arrayfun(@(r) (xi - Ve) + Ve*(1 - exp(-alpha(r)*(r-re))).^2, in);
